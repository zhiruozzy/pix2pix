...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            ...
            type=int,
            default=1,
            help="# of input image channels: 3 for RGB and 1 for grayscale"  # 修改为 1
        )
        parser.add_argument(
            "--output_nc",
            type=int,
            default=1,
            help="# of output image channels: 3 for RGB and 1 for grayscale"  # 修改为 1
        )
        # Evaluation metrics
        parser.add_argument(
            '--compute_metrics',
            action='store_true',
            help='whether to compute PSNR/SSIM during validation/testing'
        )
        parser.add_argument(
            "--ngf",
            type=int,
